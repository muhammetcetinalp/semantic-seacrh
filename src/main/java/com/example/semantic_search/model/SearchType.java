 ...
 *   <li><b>SEMANTIC:</b> Derin öğrenme vektör gömmeleri (Dense Embedding veya ColBERT Late-Interaction) temelli anlamsal arama.</li>
...
public enum SearchType {
    ...
    /** BGE-M3 veya ColBERT tabanlı anlamsal vektör araması. */
    SEMANTIC,
